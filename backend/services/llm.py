...
class CloudflareLLMService:
    ...
    async def generate_agricultural_response(
        ...
        """
        Generate a PhD-level agricultural response with a concise voice summary.
        """
        system_prompt = """You are Deep-Ag Copilot, a PhD-level agricultural advisor for Yolo County.
